...
function(add_macos_deploy_target)
  if(CMAKE_SYSTEM_NAME STREQUAL "Darwin" AND TARGET bitcoin-qt)
    # Derive app name and bundle ID from DEFAULT_CHAIN_TYPE
    if(DEFAULT_CHAIN_TYPE STREQUAL "tensor-test")
      set(MACOS_APP_NAME "TensorCash-Testnet")
      set(MACOS_BUNDLE_ID "io.tensorcash.wallet.testnet")
      set(MACOS_DISPLAY_NAME "TensorCash Testnet")
    elseif(DEFAULT_CHAIN_TYPE STREQUAL "tensor")
      set(MACOS_APP_NAME "TensorCash")
      set(MACOS_BUNDLE_ID "io.tensorcash.wallet")
      set(MACOS_DISPLAY_NAME "TensorCash")
    else()
      set(MACOS_APP_NAME "Bitcoin-Qt")
      set(MACOS_BUNDLE_ID "org.bitcoinfoundation.Bitcoin-Qt")
      set(MACOS_DISPLAY_NAME "${CLIENT_NAME}")
    endif()

    set(macos_app "${MACOS_APP_NAME}.app")
    ...
    file(CONFIGURE OUTPUT ${macos_app}/Contents/Resources/Base.lproj/InfoPlist.strings
      CONTENT "{ CFBundleDisplayName = \"${MACOS_DISPLAY_NAME}\"; CFBundleName = \"${MACOS_DISPLAY_NAME}\"; }"
    )

    add_custom_command(
      OUTPUT ${PROJECT_BINARY_DIR}/${macos_app}/Contents/MacOS/${MACOS_APP_NAME}
      ...
      COMMAND ${CMAKE_COMMAND} -E rename ${macos_app}/Contents/MacOS/bin/$<TARGET_FILE_NAME:bitcoin-qt> ${macos_app}/Contents/MacOS/${MACOS_APP_NAME}
    ...
    if(CMAKE_HOST_APPLE)
      add_custom_command(
        ...
        DEPENDS ${PROJECT_BINARY_DIR}/${macos_app}/Contents/MacOS/${MACOS_APP_NAME}
        VERBATIM
      )
      ...
      add_custom_command(
        OUTPUT ${PROJECT_BINARY_DIR}/dist/${macos_app}/Contents/MacOS/${MACOS_APP_NAME}
      ...
      add_custom_target(deploydir
        DEPENDS ${PROJECT_BINARY_DIR}/dist/${macos_app}/Contents/MacOS/${MACOS_APP_NAME}
      )
