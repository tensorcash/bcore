...
# On mingw/Windows cross-compile, the library may be named differently
# or installed in lib subdirectory of CMAKE_FIND_ROOT_PATH
find_library(QRencode_LIBRARY_RELEASE
  NAMES qrencode libqrencode qrencode_static
  PATHS ${PC_QRencode_LIBRARY_DIRS}
  HINTS ${CMAKE_FIND_ROOT_PATH}/lib ${CMAKE_FIND_ROOT_PATH}/lib64
)
find_library(QRencode_LIBRARY_DEBUG
  NAMES qrencoded qrencode libqrencoded libqrencode
  PATHS ${PC_QRencode_LIBRARY_DIRS}
  HINTS ${CMAKE_FIND_ROOT_PATH}/lib ${CMAKE_FIND_ROOT_PATH}/lib64
)
