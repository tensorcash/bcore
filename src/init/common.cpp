...
{
        // Special-case: If -nodebug is specified, disable all debug logging
        if (args.IsArgNegated("-debug")) {
            // -nodebug was specified, disable all categories and skip processing
            // This has the same effect as -debug=0 or -debug=none
