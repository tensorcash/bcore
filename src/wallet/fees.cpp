    ...
    */
    ...
    if (coin_control.m_feerate) { // 1.
        ...
        if (feerate_needed == CFeeRate(0)) {
            ...
            // If fallback fee is disabled and we're using it, don't allow it to be overridden
            // by mempool min or required fee - we want the caller to get an error
            if (feerate_needed == CFeeRate(0) && !wallet.m_allow_fallback_fee) {
