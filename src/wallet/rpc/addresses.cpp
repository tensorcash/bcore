...
RPCHelpMan getnewaddress()
{
    return RPCHelpMan{"getnewaddress",
                ...
                "\nNote: Witness v2 (post-quantum ML-DSA) addresses are NOT supported by this RPC.\n"
                "Use 'generatemldsaaddress' for witness v2 addresses instead.\n",
                {
                    {"label", RPCArg::Type::STR, RPCArg::Default{""}, "The label name for the address to be linked to. It can also be set to the empty string \"\" to represent the default label. The label does not need to exist, it will be created if there is no label by the given name."},
                    {"address_type", RPCArg::Type::STR, RPCArg::DefaultHint{"set by -addresstype"}, "The address type to use. Options are \"legacy\", \"p2sh-segwit\", \"bech32\", and \"bech32m\". Does NOT support \"v2\" or witness v2."},
                },
                RPCResult{
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    if (!request.params[1].isNull()) {
        ...
        // Explicitly reject witness v2 - it requires ML-DSA keys which cannot be generated via getnewaddress
        if (type_str == "v2" || type_str == "witness_v2" || type_str == "witnessv2") {
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY,
                "Witness v2 addresses are not supported by getnewaddress. "
                "Use 'generatemldsaaddress' for post-quantum ML-DSA addresses. "
                "Witness v2 requires script-only spending with ML-DSA signatures.");
        }
...
RPCHelpMan getrawchangeaddress()
{
    return RPCHelpMan{"getrawchangeaddress",
                ...
                "\nNote: Witness v2 (post-quantum ML-DSA) addresses are NOT supported.\n",
                {
                    {"address_type", RPCArg::Type::STR, RPCArg::DefaultHint{"set by -changetype"}, "The address type to use. Options are \"legacy\", \"p2sh-segwit\", \"bech32\", and \"bech32m\". Does NOT support \"v2\" or witness v2."},
                },
                RPCResult{
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    if (!request.params[0].isNull()) {
        ...
        // Explicitly reject witness v2 - change addresses also cannot be v2
        if (type_str == "v2" || type_str == "witness_v2" || type_str == "witnessv2") {
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY,
...
public:
    ...
    UniValue operator()(const WitnessV2Taproot& id) const { return UniValue(UniValue::VOBJ); }
