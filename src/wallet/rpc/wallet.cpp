...
// Forward declarations for pricing RPCs
...
// covenant contracts (phase 3 scaffolding)
...
// tokenized option series (OPTION_TOKENIZATION.md §6.3). derive/verify are CORE RPCs (any node, no
// wallet — see rpc/option_series.cpp); only build_register is wallet-scoped (it funds + broadcasts).
...
std::span<const CRPCCommand> GetWalletRPCCommands()
{
    static const CRPCCommand commands[]{
        ...
        {"wallet", &getbalances},
        {"wallet", &wallet_registerasset},
        {"wallet", &sponsorchildasset},
        {"wallet", &mintasset},
        {"wallet", &burnasset},
        {"wallet", &sendasset},
        {"wallet", &icu_acceptance},
        {"wallet", &icu_acceptance_record_create},
        {"wallet", &distributeasset},
        {"wallet", &asset_build_delivery_template},
        {"wallet", &generatezkproof},
        {"wallet", &generatecomplianceroot},
        {"wallet", &generatehdwitnessdata},
        {"wallet", &rotatezk},
        {"wallet", &rotateicu},
        {"wallet", &rotateasset},
        ...
        {"wallet", &listunspent},
        {"wallet", &listassetutxos},
        {"wallet", &getassetinfo},
        {"wallet", &listassets},
        {"wallet", &getassetregistry},
        {"wallet", &getassetcomplianceroot},
        {"wallet", &listassetcomplianceroots},
        {"wallet", &updatecomplianceroot},
        {"wallet", &contract_status},
        {"wallet", &contract_list},
        {"wallet", &repo_propose},
        {"wallet", &repo_accept},
        {"wallet", &repo_import_offer},
        {"wallet", &repo_export_offer},
        {"wallet", &repo_share_offer},
        {"wallet", &repo_collect_acceptance},
        {"wallet", &repo_sign_over_channel},
        {"wallet", &repo_list_offers},
        {"wallet", &repo_import_acceptance},
        {"wallet", &repo_build_open},
        {"wallet", &repo_build_repay_release},
        {"wallet", &repo_build_default_sweep},
        {"wallet", &repo_sign_default_sweep},
        {"wallet", &repo_update_repay_address},
        {"wallet", &repo_import_repay_address},
        {"wallet", &spot_propose},
        {"wallet", &spot_import_offer},
        {"wallet", &spot_export_offer},
        {"wallet", &spot_share_offer},
        {"wallet", &spot_collect_acceptance},
        {"wallet", &spot_sign_over_channel},
        {"wallet", &spot_list_offers},
        {"wallet", &spot_accept},
        {"wallet", &spot_import_acceptance},
        {"wallet", &spot_build_atomic},
        {"wallet", &spot_add_commitment_proof},
        {"wallet", &spot_mark_executed},
        {"wallet", &forward_propose},
        {"wallet", &forward_import_offer},
        {"wallet", &forward_export_offer},
        {"wallet", &forward_share_offer},
        {"wallet", &forward_collect_acceptance},
        {"wallet", &forward_sign_over_channel},
        {"wallet", &forward_close_over_channel},
        {"wallet", &forward_list_offers},
        {"wallet", &forward_accept},
        {"wallet", &forward_import_acceptance},
        {"wallet", &forward_build_open},
        {"wallet", &difficulty_propose},
        {"wallet", &difficulty_accept},
        {"wallet", &difficulty_propose_option},
        {"wallet", &difficulty_accept_option},
        {"wallet", &difficulty_import_acceptance},
        {"wallet", &difficulty_build_open},
        {"wallet", &difficulty_build_open_option},
        {"wallet", &difficulty_record_open},
        {"wallet", &difficulty_build_coop_close},
        {"wallet", &difficulty_sign_coop},
        {"wallet", &difficulty_build_settlement},
        {"wallet", &difficulty_finalize_settlement},
        {"wallet", &forward_build_coop_close},
        {"wallet", &forward_coop_contrib},
        {"wallet", &forward_build_self_delivery},
        {"wallet", &forward_build_escrow_claim},
        {"wallet", &forward_build_escrow_refund},
        {"wallet", &forward_build_im_timeout},
        {"wallet", &optionseries_build_register},
        {"wallet", &optionseries_build_issue},
        {"wallet", &optionseries_record_issue},
        {"wallet", &optionseries_list},
        ...
        {"wallet", &crosschain_list},
        {"wallet", &crosschain_get},
        {"wallet", &crosschain_set_htlc_params},
        {"wallet", &crosschain_create_record},
        {"wallet", &crosschain_set_oracle_attestation},
        {"wallet", &crosschain_register_swap},
        {"wallet", &crosschain_set_session_addresses},
        {"wallet", &crosschain_start_manager},
        {"pricing", &pricing_market_push_curve},
        {"pricing", &pricing_market_push_fx},
        {"pricing", &pricing_market_push_vol_surface},
        {"pricing", &pricing_market_push_correlation},
        {"pricing", &pricing_market_push_difficulty_curve},
        {"pricing", &pricing_market_push_difficulty_surface},
        {"pricing", &pricing_market_model_difficulty_curve},
        {"pricing", &pricing_market_calibrate_difficulty_vol},
        {"pricing", &pricing_market_status},
        {"pricing", &pricing_market_calibrate},
        {"pricing", &pricing_repo_quote},
        {"pricing", &pricing_forward_quote},
        {"pricing", &pricing_difficulty_quote},
        {"pricing", &pricing_diagnostics_scan},
        {"pricing", &pricing_portfolio_summary},
        {"pricing", &pricing_portfolio_risk},
        {"wallet", &adaptor_prepare},
        {"wallet", &adaptor_partial},
        {"wallet", &adaptor_commit_final},
        {"wallet", &adaptor_complete},
        {"wallet", &adaptor_extract_secret},
        {"wallet", &adaptor_unlock_all},
        {"wallet", &musig_keyagg},
        {"wallet", &musig_nonce_gen},
        {"wallet", &musig_nonce_agg},
        {"wallet", &musig_partial_sign},
        {"wallet", &musig_partial_sig_agg},
        {"wallet", &geticupayload},
        {"wallet", &buildcanonicalicupayload},
        {"wallet", &dumpassetdek},
        {"wallet", &prepare_rotation},
        {"wallet", &ballot},
        {"wallet", &merge_rotation},
        {"wallet", &validate_ballot},
        {"wallet", &finalize_rotation},
        ...
        {"wallet", &createmodeldeposit},
        {"wallet", &createmodelcommit},
        {"wallet", &splitutxo},
        {"wallet", &createmodelburn},
        {"wallet", &createmodelreclaim},
        {"wallet", &createchallengedeposit},
        {"wallet", &createchallengecommits},
        {"wallet", &getmodelregistrationstatus},
        {"wallet", &vaultinfo},
        {"wallet", &vaultsigndryrun},
        {"wallet", &vaultlist},
        {"wallet", &generatemldsaaddress},
        {"wallet", &signmldsatransaction},
        {"wallet", &signmldsatransactionwithwallet},
    };
    return commands;
}
} // namespace wallet
