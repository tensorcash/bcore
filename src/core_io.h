...
// Overloads for decoding from raw bytes (legacy-compat helpers for tests)
[[nodiscard]] bool DecodeHexBlk(CBlock&, const std::vector<unsigned char>& raw);
bool DecodeHexBlockHeader(CBlockHeader&, const std::string& hex_header);
bool DecodeHexBlockHeader(CBlockHeader&, const std::vector<unsigned char>& raw);
