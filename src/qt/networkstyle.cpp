...
static const struct {
    ...
    // TensorCash chains - cyan/teal hue (180°) for distinct branding
    {ChainType::TENSOR_MAIN, QAPP_APP_NAME_TENSOR, 180, 0},
    {ChainType::TENSOR_TEST, QAPP_APP_NAME_TENSOR_TEST, 180, 30},
    {ChainType::TENSOR_REG, QAPP_APP_NAME_TENSOR_REG, 200, 30},
};
