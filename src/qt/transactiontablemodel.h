...
public:
    ...
    enum ColumnIndex {
        ...
        Type = 3,
        ToAddress = 4,
        Asset = 5,       // Asset ticker/name
        AssetAmount = 6, // Asset amount (blank for TSC)
        Amount = 7       // TSC amount
    };
...
private:
    ...
    QString formatTxAsset(const TransactionRecord *wtx) const;
    QString formatTxAssetAmount(const TransactionRecord *wtx) const;
