...
public:
    ...
    /** @name Asset transaction attributes
      @{*/
    bool is_asset_transfer = false;
    std::optional<uint256> asset_id;
    QString asset_ticker;
    uint64_t asset_units = 0;
    uint8_t asset_decimals = 8;
    bool asset_has_ticker = false;
    bool asset_is_registered = false;
    /**@}*/

    /** @name Post-quantum transaction attributes
      @{*/
    bool mldsa_input = false;
    bool mldsa_output = false;
    /**@}*/
