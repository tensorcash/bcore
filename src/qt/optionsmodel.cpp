...
QVariant OptionsModel::getOption(OptionID option, const std::string& suffix) const
{
    ...
    case EnableMLDSA:
        return settings.value("enable_mldsa", true);
    case DefaultMLDSALevel:
        return settings.value("default_mldsa_level", 1);  // Default to ML-DSA-65
    case WarnMLDSAFees:
        return settings.value("warn_mldsa_fees", true);
    case WarnMLDSABackup:
        return settings.value("warn_mldsa_backup", true);
    default:
        return QVariant();
    }
}
...
bool OptionsModel::setOption(OptionID option, const QVariant& value, const std::string& suffix)
{
    ...
    case MaskValues:
        ...
        break;
    case EnableMLDSA:
        settings.setValue("enable_mldsa", value.toBool());
        break;
    case DefaultMLDSALevel:
        settings.setValue("default_mldsa_level", value.toInt());
        break;
    case WarnMLDSAFees:
        settings.setValue("warn_mldsa_fees", value.toBool());
        break;
    case WarnMLDSABackup:
        settings.setValue("warn_mldsa_backup", value.toBool());
        break;
    default:
        break;
    }
