...
{
    switch (unit) {
    case Unit::BTC: return QString("TSC");
    case Unit::mBTC: return QString("mTSC");
    case Unit::uBTC: return QString::fromUtf8("µTSC (bits)");
    case Unit::SAT: return QString("TensorAtomic (tak)");
...
{
    switch (unit) {
    case Unit::BTC: return QString("TensorCash");
    case Unit::mBTC: return QString("Milli-TensorCash (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-TensorCash (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    case Unit::SAT: return QString("TensorAtomic (tak) (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    } // no default case, so the compiler can warn about missing cases
    assert(false);
}
