...
// 512-bit wide integer, used as an exact intermediate for the difficulty-derivative
// settlement math (consensus/difficulty_cfd.cpp): products such as lambda_q*num*vault_im
// reach ~2^352 and must accumulate without truncation before the final floor-divide.
