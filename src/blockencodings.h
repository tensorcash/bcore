...
public:
    ...
    {
        READWRITE(obj.header, obj.nonce, obj.pow, obj.cumulative_tick, Using<VectorFormatter<CustomUintFormatter<SHORTTXIDS_LENGTH>>>(obj.shorttxids), obj.prefilledtxn);
...
protected:
    ...
    CProofBlob m_pow;
    uint64_t m_cumulative_tick{0};
    bool m_has_tensor{false};
public:
    CBlockHeader header;
