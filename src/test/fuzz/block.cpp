...
FUZZ_TARGET(block, .init = initialize_block)
{
    ...
    const bool valid_incl_pow_and_merkle = CheckBlock(block, validation_state_pow_and_merkle, consensus_params, /* fCheckApi= */ false, /* fCheckPOW= */ true, /* fCheckMerkleRoot= */ true);
    ...
    const bool valid_incl_pow = CheckBlock(block, validation_state_pow, consensus_params, /* fCheckApi= */ false, /* fCheckPOW= */ true, /* fCheckMerkleRoot= */ false);
    ...
    const bool valid_incl_merkle = CheckBlock(block, validation_state_merkle, consensus_params, /* fCheckApi= */ false, /* fCheckPOW= */ false, /* fCheckMerkleRoot= */ true);
    ...
    const bool valid_incl_none = CheckBlock(block, validation_state_none, consensus_params, /* fCheckApi= */ false, /* fCheckPOW= */ false, /* fCheckMerkleRoot= */ false);
