...
private:
    ...
    /** Query HTTP seed API endpoints and add returned peers to addrman.
     *  @param max_retries  Number of retry attempts per URL on failure.
     *  @return number of addresses added. */
    int FetchHttpSeeds(int max_retries = 0);
