...
struct WitnessV2Taproot : public XOnlyPubKey
{
    WitnessV2Taproot() : XOnlyPubKey() {}
    explicit WitnessV2Taproot(const XOnlyPubKey& xpk) : XOnlyPubKey(xpk) {}
    explicit WitnessV2Taproot(const uint256& hash) : XOnlyPubKey() {
 ...
 */
using CTxDestination = std::variant<CNoDestination, PubKeyDestination, PKHash, ScriptHash, WitnessV0ScriptHash, WitnessV0KeyHash, WitnessV1Taproot, WitnessV2Taproot, PayToAnchor, WitnessUnknown>;
