...
class P2PCompactBlocksBlocksOnly(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        p2p_conn_blocksonly.send_headers_with_sidecars_and_ping(block1, include_sidecars=False)
        assert_equal(p2p_conn_blocksonly.last_message['getdata'].inv, [CInv(MSG_BLOCK | MSG_WITNESS_FLAG, block1.sha256)])

        p2p_conn_high_bw.send_headers_with_sidecars_and_ping(block1)
        ...
        p2p_conn_low_bw.send_headers_with_sidecars_and_ping(block1)
