...
class BIP68Test(BitcoinTestFramework):
    ...
    def test_sequence_lock_unconfirmed_inputs(self):
        ...
        for i in range(2):
            ...
            # Use the prev hash from the template which was already set in create_block
            ...
            tmpl = self.nodes[0].getblocktemplate(NORMAL_GBT_REQUEST_PARAMS)
            tmpl['previousblockhash'] = '%064x' % tip
            tmpl['transactions'] = []
            cur_time += 1
    ...
    def test_bip68_not_consensus(self):
        ...
        from test_framework.blocktools import set_block_tick_from_prev
        set_block_tick_from_prev(self.nodes[0], block, self.nodes[0].getbestblockhash())
