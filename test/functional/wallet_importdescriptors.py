...
class ImportDescriptorsTest(BitcoinTestFramework):
    def set_test_params(self):
        ...
        self.extra_args = [["-addresstype=legacy"],
                           ["-addresstype=bech32", "-keypool=5", "-spv-asn-corroboration=0"]
                          ]
    ...
    def run_test(self):
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=1) as thread:
            with self.nodes[0].assert_debug_log(expected_msgs=["Rescan started from block cf63c021e5a8ea0bc04cf7b12ab12e0a7902ef2dae5bdd8cbb3a0d41c3345da4... (slow variant inspecting all blocks)"], timeout=10):
