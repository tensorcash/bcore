...
OP_OUTPUTMATCH_NATIVE = CScriptOp(0xb7)
OP_OUTPUTMATCH_ASSET = CScriptOp(0xb8)
...
OPCODE_NAMES.update({
    ...
    OP_NOP6: 'OP_NOP6',
    OP_NOP7: 'OP_NOP7',
    OP_OUTPUTMATCH_NATIVE: 'OP_OUTPUTMATCH_NATIVE',
    OP_OUTPUTMATCH_ASSET: 'OP_OUTPUTMATCH_ASSET',
    OP_NOP10: 'OP_NOP10',
...
def is_op_success(o):
    # Mirrors IsOpSuccess in src/script/script.cpp: 0xBD (OP_NBITS_AT) and
    # 0xBE (OP_DIFFCFD_SETTLE) are real genesis-active covenant opcodes, so
    # the OP_SUCCESS sweep starts at 0xBF.
    return (
        o == 0x50
        or o == 0x62
        or (0x7E <= o <= 0x81)
