...
class InvalidMessagesTest(BitcoinTestFramework):
    ...
    def test_invalid_pow_headers_msg(self):
        ...
        blockheader.nAdjBits = blockheader_tip.nBits  # Initialize Tensor field
        blockheader.rehash()
        # For Tensor, PoW uses short_hash not full hash
        while not blockheader.short_hash.startswith('0'):
        ...
        # invalidate PoW (Tensor uses short_hash for PoW)
        while not blockheader.short_hash.startswith('f'):
            blockheader.nNonce += 1
            blockheader.rehash()
