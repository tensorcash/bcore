...
class DataCarrierTest(BitcoinTestFramework):
    def set_test_params(self):
        ...
        self.extra_args = [
            ...
            ["-datacarrier=0", "-spv-asn-corroboration=0"],
            ["-datacarrier=1", f"-datacarriersize={MAX_OP_RETURN_RELAY - 1}", "-spv-asn-corroboration=0"],
            ["-datacarrier=1", "-datacarriersize=2", "-spv-asn-corroboration=0"],
        ]
