...
class AddressTypeTest(BitcoinTestFramework):
    def set_test_params(self):
        self.num_nodes = 6
        self.extra_args = [
            ["-addresstype=legacy", "-spv-asn-corroboration=0"],
            ["-addresstype=p2sh-segwit", "-spv-asn-corroboration=0"],
            ["-addresstype=p2sh-segwit", "-changetype=bech32", "-spv-asn-corroboration=0"],
            ["-addresstype=bech32", "-spv-asn-corroboration=0"],
            ["-changetype=p2sh-segwit", "-spv-asn-corroboration=0"],
