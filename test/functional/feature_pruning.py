...
def mine_large_blocks(node, n):
    ...
    for _ in range(n):
        ...
        # previousblockhash is an int
        set_block_tick_from_prev(node, block, f"{previousblockhash:064x}")
        block.solve()
        register_block_tick_cache(block)
...
class PruneTest(BitcoinTestFramework):
    def set_test_params(self):
        ...
        self.extra_args = [
            ...
            self.full_node_default_args,
            ["-maxreceivebuffer=20000", "-prune=550", "-spv-asn-corroboration=0"],
            ["-maxreceivebuffer=20000", "-spv-asn-corroboration=0"],
            ["-maxreceivebuffer=20000", "-spv-asn-corroboration=0"],
            ["-prune=550", "-blockfilterindex=1", "-spv-asn-corroboration=0"],
        ]
