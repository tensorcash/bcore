...
class InvalidBlockRequestTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        set_block_tick_from_prev(node, block, f"{tip:064x}")
        block.solve()
        ...
        set_block_tick_from_prev(node, block2, f"{tip:064x}")
        block_time += 1
        block2.solve()
        ...
        set_block_tick_from_prev(node, block3, f"{tip:064x}")
        block_time += 1
        block3.solve()
        ...
        set_block_tick_from_prev(node, block4, f"{tip:064x}")
        block4.solve()
