...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    def build_block_on_tip(self, node):
        ...
        set_block_tick_from_prev(self.nodes[0], block, node.getbestblockhash())
        block.solve()
        return block
    ...
    def test_invalid_cmpctblock_message(self):
        ...
        cmpct_block.pow = copy.deepcopy(block.pow)
        cmpct_block.cumulative_tick = block.cumulative_tick
    ...
    def test_compactblock_requests(self, test_node):
        ...
        for announce in ["inv", "header"]:
            ...
            comp_block.pow = copy.deepcopy(block.pow)
            comp_block.cumulative_tick = block.cumulative_tick
            comp_block.nonce = 0
