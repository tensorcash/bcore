...
class BIP68_112_113Test(BitcoinTestFramework):
    ...
    def create_test_block(self, txs):
        ...
        # Only use set_block_tick_from_prev if the previous block exists in the node
        # For blocks being built in memory before submission, just use cumulative_tick = 0
        try:
            ...
            # Previous block doesn't exist in node yet, set cumulative_tick to 0
